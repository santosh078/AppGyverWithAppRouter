...
function getDestinationToken(options, token, credentials, cb) {
  ...
  // If no tenant or preferLocal, take destination client credentials token (provider destination, public access, not multi-tenant approuter or SaaS Approuter APIs)
